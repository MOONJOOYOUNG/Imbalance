...
def main():
    ...
    train_loader, valid_loader, test_loader, train_feature_loader = data.data_set(args.batch_size,save_path,args.data)
    ...
    for epoch in range(0, args.epoch):
        ...
        # save files
        utlis.save_epoch_data('train_loss_idv', train_loss_idv, save_path,epoch+1)
        utlis.save_epoch_data('feature_loss_idv', feature_loss_idv, save_path,epoch+1)
